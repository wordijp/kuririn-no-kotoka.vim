" Vim color file - golden
" Generated by http://bytefluent.com/vivify 2016-12-09
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Normal guifg=#ddbb00 guibg=#000000 guisp=#000000 gui=NONE ctermfg=178 ctermbg=NONE cterm=NONE
...
hi Title guifg=#DBCA98 guibg=NONE guisp=NONE gui=bold ctermfg=180 ctermbg=NONE cterm=bold
...
hi StatusLineNC guifg=#bebebe guibg=#3E3E3E guisp=#3E3E3E gui=NONE ctermfg=7 ctermbg=237 cterm=NONE
hi NonText guifg=#DBCA98 guibg=NONE guisp=NONE gui=bold ctermfg=180 ctermbg=NONE cterm=bold
...
hi Identifier guifg=#DBCA98 guibg=NONE guisp=NONE gui=NONE ctermfg=180 ctermbg=NONE cterm=NONE
...
hi Todo guifg=#FFE13F guibg=#2E2E2E guisp=#2E2E2E gui=NONE ctermfg=221 ctermbg=236 cterm=NONE
...
hi StatusLine guifg=#978345 guibg=#2E2E2E guisp=#2E2E2E gui=bold ctermfg=143 ctermbg=236 cterm=bold
...
hi Comment guifg=#978345 guibg=NONE guisp=NONE gui=bold ctermfg=143 ctermbg=NONE cterm=bold
...
hi Question guifg=#ffddaa guibg=NONE guisp=NONE gui=bold ctermfg=223 ctermbg=NONE cterm=bold
hi WarningMsg guifg=#ff0000 guibg=NONE guisp=NONE gui=bold ctermfg=196 ctermbg=NONE cterm=bold
hi ModeMsg guifg=#000000 guibg=#ddbb00 guisp=#ddbb00 gui=bold ctermfg=NONE ctermbg=178 cterm=bold
hi Define guifg=#ffddaa guibg=NONE guisp=NONE gui=NONE ctermfg=223 ctermbg=NONE cterm=NONE
hi Function guifg=#DBCA98 guibg=NONE guisp=NONE gui=NONE ctermfg=180 ctermbg=NONE cterm=NONE
hi PreProc guifg=#ffddaa guibg=NONE guisp=NONE gui=NONE ctermfg=223 ctermbg=NONE cterm=NONE
...
hi Type guifg=#FFE13F guibg=NONE guisp=NONE gui=bold ctermfg=221 ctermbg=NONE cterm=bold
hi Cursor guifg=#000000 guibg=#FF5E06 guisp=#FF5E06 gui=NONE ctermfg=NONE ctermbg=202 cterm=NONE
...
hi Constant guifg=#ff0000 guibg=NONE guisp=NONE gui=bold ctermfg=196 ctermbg=NONE cterm=bold
hi Tag guifg=#ffa500 guibg=NONE guisp=NONE gui=bold ctermfg=214 ctermbg=NONE cterm=bold
hi String guifg=#ff0000 guibg=NONE guisp=NONE gui=bold ctermfg=196 ctermbg=NONE cterm=bold
